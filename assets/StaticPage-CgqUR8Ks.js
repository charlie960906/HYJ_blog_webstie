import{j as e,L as i}from"./index-BbhO7STa.js";import{A as l}from"./arrow-left-B9cytGTS.js";const a={about:{title:"關於我",content:`
      <div class="space-y-6">
    ...
    `}},d=t=>a[t],n=({pageKey:t})=>{const s=d(t);return s?e.jsx("div",{className:"min-h-screen pt-20 px-4",children:e.jsxs("div",{className:"container mx-auto max-w-4xl",children:[e.jsxs(i,{to:"/",className:"inline-flex items-center text-white/80 hover:text-white transition-colors mb-8",children:[e.jsx(l,{className:"w-4 h-4 mr-2"}),"返回首頁"]}),e.jsxs("div",{className:"glassmorphism-card p-8",children:[e.jsx("h1",{className:"text-4xl font-bold text-white mb-8",children:s.title}),e.jsx("div",{className:"prose prose-invert prose-lg max-w-none",dangerouslySetInnerHTML:{__html:s.content}})]})]})}):e.jsx("div",{className:"min-h-screen flex items-center justify-center pt-20",children:e.jsxs("div",{className:"glassmorphism-card p-8 text-center",children:[e.jsx("h1",{className:"text-2xl font-bold text-white mb-4",children:"頁面未找到"}),e.jsxs(i,{to:"/",className:"inline-flex items-center px-4 py-2 bg-blue-500 text-white rounded-full hover:bg-blue-600 transition-colors",children:[e.jsx(l,{className:"w-4 h-4 mr-2"}),"返回首頁"]})]})})};export{n as default};
